...
class TestRetryWithBackoff:
    ...
    async def test_success_after_retries(self):
        ...
        with patch("kron.services.utilities.resilience.sleep", new_callable=AsyncMock):
    ...
    async def test_all_retries_exhausted(self):
        ...
        with (
            patch("kron.services.utilities.resilience.sleep", new_callable=AsyncMock),
    ...
    async def test_exponential_backoff_delays(self):
        ...
        with patch("kron.services.utilities.resilience.sleep", mock_sleep):
            result = await retry_with_backoff(
                mock_func,
                max_retries=3,
                initial_delay=1.0,
